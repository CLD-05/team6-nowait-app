...
const styles = `
  ...
  .lp .logo{font-weight:900;font-size:25px;letter-spacing:-.05em;line-height:1.5;display:flex;align-items:center;gap:3px;cursor:pointer}
  .lp .logo .b{background:var(--tomato);color:#fff;border:2.5px solid var(--ink);border-radius:9px;padding:1px 9px;line-height:1.5;transform:rotate(-3deg);box-shadow:3px 3px 0 var(--ink)}
    ...
    <div className="lp">
      <header>
        <div className="wrap nav">
          <div className="logo" onClick={() => navigate('/')}>No<span className="b">wait</span></div>
      ...
      <footer>
        <div className="wrap">
          <div className="foot">
            <div><div className="logo">No<span className="b">wait</span></div><p className="desc">기다림 없는 외식, 노웨이트! 손님과 맛집을 가장 신나게 연결하는 웨이팅·예약 서비스.</p></div>
